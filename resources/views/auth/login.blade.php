    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
      ...
      <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
          ...
          <div class="tx-white-5 tx-center mg-b-60">Log In All User Here</div>
          ...
          <form action="{{ route('login') }}" method="POST">
            ...
            <div class="form-group">
                <input name="email" type="text" class="form-control fc-outline-dark" placeholder="Enter Your Email">
            </div><!-- form-group -->
            ...
            <button type="submit" class="mb-3 btn btn-info btn-block">Login</button>
